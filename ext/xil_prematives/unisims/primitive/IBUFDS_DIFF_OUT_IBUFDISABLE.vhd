  ...
  begin
    -------- DIFF_TERM check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("-102] DIFF_TERM attribute is set to """));
    ...
    -------- DQS_BIAS check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-103] DQS_BIAS attribute is set to """));
    ...
    -------- IOSTANDARD check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-106] IOSTANDARD attribute is set to """));
