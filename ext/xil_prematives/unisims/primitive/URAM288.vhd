...
--  end process; 
  ...
  ram_data_a_out_p : process begin
    ...
    wait on RST_A_sync, RST_A_async, glblGSR, SLEEP_in, a_sleep, ram_ce_a, ram_we_a, shut_down, ram_data_a_out;  --zh to add ram_ce_a ram_we_a
  end process;
  ...
  ram_data_b_out_p : process begin
    ...
    wait on RST_B_sync, RST_B_async, glblGSR, SLEEP_in, a_sleep, ram_ce_b, ram_we_b, shut_down, ram_data_b_out;
  end process;
